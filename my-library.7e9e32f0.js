 ...
 * limitations under the License.
 */
class be{static Wrap(e,t){return new be(e,t)}constructor(e,t){this.name=e,this.node=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{getCompare(){return this.compare.bind(this)}indexedValueChanged(e,t){const n=new be("[MIN_NAME]",e),i=new be("[MIN_NAME]",t);return 0!==this.compare(n,i)}minPost(){return be.MIN}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Le(e,t){return M(e.name,t.name)}function Ae(e,t){return M(e,t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Ge;const $e={};class Qe{static get Default(){return(0,c.assert)($e&&ze,"ChildrenNode.ts has not been loaded"),Ge=Ge||new Qe({".priority":$e},{".priority":ze}),Ge}get(e){const t=(0,c.safeGet)(this.indexes_,e);if(!t)throw new Error("No index defined for "+e);return t instanceof Fe?t:null}hasIndex(e){return(0,c.contains)(this.indexSet_,e.toString())}addIndex(e,t){(0,c.assert)(e!==Re,"KeyIndex always exists and isn't meant to be added to the IndexMap.");const n=[];let i=!1;const s=t.getIterator(be.Wrap);let r,o=s.getNext();for(;o;)i=i||e.isDefinedOn(o.node),n.push(o),o=s.getNext();r=i?Ke(n,e.getCompare()):$e;const a=e.toString(),l=Object.assign({},this.indexSet_);l[a]=e;const h=Object.assign({},this.indexes_);return h[a]=r,new Qe(h,l)}addToIndexes(e,t){const n=(0,c.map)(this.indexes_,((n,i)=>{const s=(0,c.safeGet)(this.indexSet_,i);if((0,c.assert)(s,"Missing index implementation for "+i),n===$e){if(s.isDefinedOn(e.node)){const n=[],i=t.getIterator(be.Wrap);let r=i.getNext();for(;r;)r.name!==e.name&&n.push(r),r=i.getNext();return n.push(e),Ke(n,s.getCompare())}return $e}{const i=t.get(e.name);let s=n;return i&&(s=s.remove(new be(e.name,i))),s.insert(e,e.node)}}));return new Qe(n,this.indexSet_)}removeFromIndexes(e,t){const n=(0,c.map)(this.indexes_,(n=>{if(n===$e)return n;{const i=t.get(e.name);return i?n.remove(new be(e.name,i)):n}}));return new Qe(n,this.indexSet_)}constructor(e,t){this.indexes_=e,this.indexSet_=t}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kt{operationForChild(e){return ye(this.path)?new kt(this.source,ce(),this.snap.getImmediateChild(e)):new kt(this.source,_e(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=wt.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bt{operationForChild(e){if(ye(this.path)){const t=this.children.subtree(new he(e));return t.isEmpty()?null:t.value?new kt(this.source,ce(),t.value):new bt(this.source,ce(),t)}return(0,c.assert)(ue(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new bt(this.source,_e(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=wt.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),o.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,r);s.forEach((s=>{s.respondsTo(n.type)&&t.push(s.createEvent(i,e.query_))}))}))}function Rt(e,t){return{eventCache:e,serverCache:t}}function Mt(e,t,n,i){return Rt(new St(t,n,i),e.serverCache)}function Dt(e,t,n,i){return Rt(e.eventCache,new St(t,n,i))}function Ft(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function Lt(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const un=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class dn{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new St(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return an(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:Lt(this.viewCache_),s=on(this.writes_,i,t,1,n,e);return 0===s.length?null:s[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let kn,bn;class Sn{constructor(){this.views=new Map}}function Pn(e,t,n,i){const s=t.source.queryId;if(null!==s){const r=e.views.get(s);return(0,c.assert)(null!=r,"SyncTree gave us an op for an invalid query."),En(r,t,n,i)}{let s=[];for(const r of e.views.values())s=s.concat(En(r,t,n,i));return s}}function xn(e,t,n,i,s){const r=t._queryIdentifier,o=e.views.get(r);if(!o){let e=tn(n,s?i:null),r=!1;e?r=!0:i instanceof Je?(e=nn(n,i),r=!1):(e=Je.EMPTY_NODE,r=!1);const o=Rt(new St(e,r,!1),new St(i,s,!1));return new Cn(t,o)}return o}function Rn(e,t,n,i){const s=t._queryIdentifier,r=[];let o=[];const a=An(e);if("default"===s)for(const[t,s]of e.views.entries())o=o.concat(In(s,n,i)),Tn(s)&&(e.views.delete(t),s.query._queryParams.loadsAllData()||r.push(s.query));else{const t=e.views.get(s);t&&(o=o.concat(In(t,n,i)),Tn(t)&&(e.views.delete(s),t.query._queryParams.loadsAllData()||r.push(t.query)))}return a&&!An(e)&&r.push(new((0,c.assert)(kn,"Reference.ts has not been loaded"),kn)(t._repo,t._path)),{removed:r,events:o}}function Mn(e){const t=[];for(const n of e.views.values())n.query._queryParams.loadsAllData()||t.push(n);return t}function Dn(e,t){let n=null;for(const i of e.views.values())n=n||wn(i,t);return n}function Fn(e,t){if(t._queryParams.loadsAllData())return qn(e);{const n=t._queryIdentifier;return e.views.get(n)}}function Ln(e,t){return null!=Fn(e,t)}function An(e){return null!=qn(e)}function qn(e){for(const t of e.views.values())if(t.query._queryParams.loadsAllData())return t;return null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ms=l.SDK_VERSION,_=ms,(0,l._registerComponent)(new(0,h.Component)("database",((e,{instanceIdentifier:t})=>_s(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,l.registerVersion)("@firebase/database","0.13.3",gs),(0,l.registerVersion)("@firebase/database","0.13.3","esm2017");class ys{async readUserData(e){const t=ls(fs());let n;try{if(n=await(i=hs(t,`users/${e}`),Yi((i=(0,c.getModularInstance)(i))._repo,i).then((e=>new as(e,new os(i._repo,i._path),i._queryParams.getIndex())))),n.exists())return n.val()}catch(e){console.log(e)}var i;return null}writeUserData(e,t,n){cs(ls(fs(),"users/"+e),{watched:t,queue:n})}}var vs=i("l63jN");const Cs=document.querySelector(".js-watched"),ws=document.querySelector(".js-queue"),Ts=document.querySelector(".gallery"),Is=document.querySelector("#tui-pagination-container"),Es=document.querySelector(".footer__link"),Ns=document.querySelector(".link__up"),ks=new ys;function bs(e){Cs.classList.remove("active"),ws.classList.remove("active"),e.target.classList.add("active"),localStorage.setItem("currentLibrary",e.target.name),Ss(1)}async function Ss(e){const t=JSON.parse(sessionStorage.getItem("user")),n=(t?await ks.readUserData(t.uid):null)||{},i=localStorage.getItem("currentLibrary"),o=t?n[i]||[]:JSON.parse(localStorage.getItem(i))||[],a=function(){let e;e=window.innerWidth>=1280?9:window.innerWidth>=768?8:4;return e}(),l=(0,r.default)(o.length,a);let h;l.on("afterMove",(e=>{if(Is.removeAttribute("style"),o.length<=a){if(2===e.page)return void l.movePageTo(1);Is.setAttribute("style","display: none")}h=o.slice(e.page*a-a,e.page*a),Ts.innerHTML=(0,s.default)(h),localStorage.setItem("gallery",JSON.stringify(h)),sessionStorage.setItem("currentPage",e.page)})),l.movePageTo(e)}document.body.addEventListener("close",(function(){Ss(sessionStorage.getItem("currentPage"))})),window.addEventListener("scroll",(function(){window.pageYOffset<100?Ns.classList.add("visually-hidden"):Ns.classList.remove("visually-hidden")})),Ts.addEventListener("click",o.default),Es.addEventListener("click",vs.default),(0,a.default)(),Cs.addEventListener("click",bs),ws.addEventListener("click",bs),"queue"===localStorage.getItem("currentLibrary")?ws.dispatchEvent(new Event("click")):Cs.dispatchEvent(new Event("click"));
//# sourceMappingURL=my-library.7e9e32f0.js.map
