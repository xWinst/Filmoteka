 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ms=l.SDK_VERSION,_=ms,(0,l._registerComponent)(new(0,h.Component)("database",((e,{instanceIdentifier:t})=>_s(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,l.registerVersion)("@firebase/database","0.13.3",gs),(0,l.registerVersion)("@firebase/database","0.13.3","esm2017");class ys{async readUserData(e){const t=ls(fs());let n;try{if(n=await(i=hs(t,`users/${e}`),Yi((i=(0,c.getModularInstance)(i))._repo,i).then((e=>new as(e,new os(i._repo,i._path),i._queryParams.getIndex())))),n.exists())return n.val()}catch(e){console.log(e)}var i;return null}writeUserData(e,t,n){cs(ls(fs(),"users/"+e),{watched:t,queue:n})}}var vs=i("l63jN");const Cs=document.querySelector(".js-watched"),ws=document.querySelector(".js-queue"),Ts=document.querySelector(".gallery"),Is=document.querySelector("#tui-pagination-container"),Es=document.querySelector(".footer__link"),Ns=new ys;function ks(e){Cs.classList.remove("active"),ws.classList.remove("active"),e.target.classList.add("active"),localStorage.setItem("currentLibrary",e.target.name),bs(1)}async function bs(e){const t=JSON.parse(sessionStorage.getItem("user")),n=(t?await Ns.readUserData(t.uid):null)||{},i=localStorage.getItem("currentLibrary"),o=t?n[i]||[]:JSON.parse(localStorage.getItem(i))||[],a=function(){let e;e=window.innerWidth>=1280?9:window.innerWidth>=768?8:4;return e}(),l=(0,r.default)(o.length,a);let h;l.on("afterMove",(e=>{if(Is.removeAttribute("style"),o.length<=a){if(2===e.page)return void l.movePageTo(1);Is.setAttribute("style","display: none")}h=o.slice(e.page*a-a,e.page*a),Ts.innerHTML=(0,s.default)(h),localStorage.setItem("gallery",JSON.stringify(h)),sessionStorage.setItem("currentPage",e.page)})),l.movePageTo(e)}document.body.addEventListener("close",(function(){bs(sessionStorage.getItem("currentPage"))})),Ts.addEventListener("click",o.default),Es.addEventListener("click",vs.default),(0,a.default)(),Cs.addEventListener("click",ks),ws.addEventListener("click",ks),"queue"===localStorage.getItem("currentLibrary")?ws.dispatchEvent(new Event("click")):Cs.dispatchEvent(new Event("click"));
//# sourceMappingURL=my-library.6042fada.js.map
